        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-light-500 hover:text-light-700 hover:border-light-300 focus:outline-none focus:text-light-700 focus:border-light-300 transition duration-150 ease-in-out">
