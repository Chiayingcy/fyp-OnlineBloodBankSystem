...
<head>
    ...
    <title>Admin View Search Hospitals List</title>
...
<div id="content">
    ...
    <h2>Admin View Search Hospitals List </h2>
    ...
    <div class="row align-items-center">
        ...
        <a href="{{ route ('Admin.addDonor') }}" class="btn btn-primary col-sm-2">Add New Hospital</a>
            ...
            <table class="table table-hover table-bordered mx-auto mt-4">
                ...
                <tr>
                    <td colspan="3" class="align-center text-dark">{{ $hospital->id }}</td>
                    ...
                    <td colspan="3" class="align-center text-dark"><button type='button align-center' class='btn btn-primary'><a href="editViewDonor/{{ $hospital->id }}">Edit Information Details</a></button> </td>
                    
                    </tr>


                 @empty
                    <li class="list-group-item list-group-item-danger">Hospital Not Found.</li>
                @endforelse
                </tbody>
            </table>  
            {{ $Hospitals->links() }} 
