...
<head>
    ...
    <title>Admin View All Hospitals Blood Request Page</title>
...
<body>
    ...
    <div id="content">
        ...
        <h2>Admin View All Hospitals Blood Request</h2>
                ...
                <table class="table table-hover table-bordered mx-auto mt-4">
                    <thead>
                        <tr>
                            ...
                            <th colspan="3" class="align-center bg-dark text-light">@sortablelink('bloodType', 'BloodType')</th>
                            <th colspan="3" class="align-center bg-dark text-light">@sortablelink('bloodQuantity', 'Blood Quantity')</th>
                            <th colspan="3" class="align-center bg-dark text-light">Requested Date Time</th>
                            <th colspan="3" class="align-center bg-dark text-light">@sortablelink('bloodRequestStatus', 'status')</th>
                            <th colspan="3" class="align-center bg-dark text-light">@sortablelink('bloodRequirement', 'Blood Requirement')</th>
                    ...
                    <tbody>
                        @foreach ($bloodRequests as $bloodRequest)
                            <tr>
                                ...
                                <td colspan="3" class="align-center text-dark">
                                    {{ $bloodRequest->hospital->hospitalName }}
                                </td>

                                <td colspan="3" class="align-center text-dark">
                                    {{ $bloodRequest->bloodTypes->bloodType }}
                                </td>

                                <td colspan="3" class="align-center text-dark">
                                    {{ $bloodRequest->bloodQuantity }}
                                </td>
                                ...
                                <td colspan="3" class="align-center text-dark">
                                    @if ($bloodRequest->bloodRequirement == 1)
