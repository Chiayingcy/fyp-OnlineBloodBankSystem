...
<head>
    ...
    <title>Admin Edit Donor Information Page</title>
...
<div id="content">
    ...
    <h2>Admin Edit Donor Information </h2>
    ...
    <div class="row align-items-center">
        ...
        <form method="POST" class= "mt-4 border border-dark" action="{{ route('Admin.editDonor.update',$User->id) }}" >
