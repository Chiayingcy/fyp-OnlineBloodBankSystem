...
<head>
    ...
    <title>View Blood Donation History Page</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="py-12">
                    ...
                    <table class="table table-hover table-bordered mx-auto">
                        <thead>
                            <tr>
                                ...
                                <th colspan="3" class="align-center bg-dark text-light">@sortablelink('Appointment Status')</th>
                                <th colspan="3" class="align-center bg-dark text-light">@sortablelink('Created At')</th>
                        ...
                        <tbody>
                            @foreach ($donetListnew as $donetList)
                                @if ($donetList->appointmentStatus == 1)
                                    <tr>
                                    ...
                                    <td colspan="3" class="align-center text-dark">
                                        @if ($donetList->appointmentStatus == 0)
                                            Pending

                                        @elseif($donetList->appointmentStatus == 1)
                                            Success

                                        @elseif($donetList->appointmentStatus == 2)
                    ...
                    {{-- {!! $donetList->appends(\Request::except('page'))->render() !!} --}}
                </div>
            </div>
            <br />
