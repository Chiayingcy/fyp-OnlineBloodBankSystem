...
<head>
    ...
    <title>Hospitals Add Blood Bank Inventory</title>
...
<div id="content">
    ...
    <h2>Hospitals Add Blood Bank Inventory </h2>
    ...
    <div class="row align-items-center">
        ...
        <form method="POST" class= "mt-4 border border-dark" action="{{ route('Hospitals.addBloodBankInventory') }}" >
            ...
            <div class="form-group mt-4 mx-2">
                ...
                <input type="number" class="form-control" id="bloodQuantity" name="bloodQuantity" min="1" :value="old('bloodQuantity')" required>
            </div>

                <button type="submit" class="btn btn-primary mt-4 mx-2 my-4 ">Add New Blood Bank Inventory</button>
        </form>
