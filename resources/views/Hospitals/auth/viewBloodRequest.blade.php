...
<head>
    ...
    <title>Hospitals View Blood Request Status</title>
...
<div id="content">
    ...
    <h2>Hospital View Blood Request List </h2>
    ...
    <div class="row align-items-center">
        ...
        <a href="{{ route ('Hospitals.bloodRequest') }}" class="btn btn-primary col-sm-2">Request Blood</a>
            ...
            <table class="table table-hover table-bordered mx-auto mt-4">
                <thead>
                    <tr>
                        ...
                        <th colspan="3" class="align-center bg-dark text-light">@sortablelink('bloodRequirement', 'Blood Requirement (Reason Request Blood)')</th>
                        <th colspan="3" class="align-center bg-dark text-light">Blood Requested Time</th>
                        <th colspan="3" class="align-center bg-dark text-light">Reason Admin Rejected</th>
                ...
                <tr>
                    ...
                    <td colspan="3" class="align-center text-dark">
                        ...
                        @elseif($bloodRequest->bloodRequestStatus == 2)
                            <span class="badge badge-danger">Fail</span>
                        @endif
                    </td>

                    <td colspan="3" class="align-center text-dark">
                        @if ($bloodRequest->bloodRequirement == 0)
                        <li class="list-group-item list-group-item-warning">Blood Request</li>

                        @elseif($bloodRequest->bloodRequirement == 1)
                        <li class="list-group-item list-group-item-danger">Emergency Blood Request</li>
