...
<head>
    ...
    <title>Hospitals View Event Page</title>
...
<div id="content">
    ...
    <h2>Hospital View Event List </h2>
    ...
    <div class="row align-items-center">
        ...
        <a href="{{ route ('Hospitals.event.create') }}" class="btn btn-primary col-sm-1">Add Event</a>
            ...
            <table class="table table-hover table-bordered mx-auto mt-4">
                <thead>
                    <tr>
                        ...
                        <th class="align-center bg-dark text-light">{{ __('Action') }}</th>
                    </tr>
                </thead>
