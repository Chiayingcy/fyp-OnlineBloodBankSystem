...
<head>
    ...
    <title>Hospitals Add Event Page</title>
...
<div id="content">
   ...
   <div class="row align-items-center">
      <div class="py-12 w-100">
         ...
         <form method="POST" class= "mt-4 border border-dark" action="{{ route('Hospitals.event') }}" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="form-group mt-4 mx-2">
               ...
               <input type="text" class="form-control" id="eventName" name="eventName" :value="old('eventName')" required autofocus>
            </div>
            ...
            <div class="form-group mt-4 mx-2">
               ...
               <textarea type="text" class="form-control" id="eventDescription" name="eventDescription" :value="old('eventDescription')" required autofocus></textarea>
            </div>

            <!-- Event Poster/Image -->
            <div class="form-group mt-4 mx-2">
               <label for="image">Event Image:</label>
               <input type="file" class="form-control" id="image" name="image" required autofocus>
            </div>
            
            <button type="submit" class="btn btn-primary mt-4 mx-2 my-4 ">Create New Event</button>
         </form>
      </div>    
   </div>
<br/>
