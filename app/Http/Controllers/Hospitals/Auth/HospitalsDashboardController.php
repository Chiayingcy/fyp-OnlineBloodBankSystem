...
class HospitalsDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Hospitals.auth.dashboard', compact('EmergencyBloodPending', 'totalDonorAppoiment', 'EmergencyBloodSuccess', 'EmergencyBloodFail', 'RequestBloodPending', 'RequestBloodSuccess', 'RequestBloodFail', 'donorAppointment'));
    }
    ...
    public function viewDonorAppointment()
    {
        ...
        $donorAppointment = Appointment::where('hospitalID', $hospitalID)
                            ...
                            ->select('appointments.*', 'users.*', 'blood_types.bloodType', )
                            ->sortable()
                            ->paginate(5);
